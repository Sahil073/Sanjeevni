...
We are building **Sanjeevni**, an AI-powered health companion mobile app using **React Native**.

The app connects to a wearable device through **Bluetooth Low Energy (BLE)** and provides real-time health and environmental monitoring. It uses **on-device AI** to detect potential health risks and continues to function even when internet connectivity is unavailable.

The app includes:

- Real-time ECG and heart-health monitoring
- SpO₂ and heart-rate monitoring
- Temperature and humidity monitoring
- Heat-index and dehydration-risk monitoring
- Air-quality and AQI monitoring
- Activity tracking and fall detection
- On-device AI risk detection using TensorFlow Lite
- Disaster-specific alerts for heat and poor air quality
- Offline health-data storage using SQLite
- Real-time phone and wearable alerts
- Emergency SOS with GPS location and SMS, even without internet
- Wearable/BLE device connection and monitoring
- Health history and trend visualization
- User profile and emergency contacts
- Device and connectivity settings
- Alert and notification preferences
- Privacy and local-data management
- A simple, accessible, mobile-first UI designed for continuous everyday use

The app is primarily being developed as a **Smart India Hackathon prototype**. The goal is to demonstrate a secure, offline-first health companion that combines wearable sensing, BLE communication, on-device AI, environmental awareness, and emergency response into a single system.
